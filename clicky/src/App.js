...
class App extends Component {
    ...
    selected = id => {
        ...
        if (this.state.clicked.includes(selectedZodiac[0].id)){
            ...
            turnLost = true
            if (currentpoints > this.state.highest){
                this.setState({highest: currentpoints})
            }
        ...
        if (turnLost === true){
            ...
            this.setState({highest: currentpoints, points: 0, message: "You WON! Let's Play Again"})
        } else {
            return;
        }
    ...
    render () {
        ...
        <Title highest = {this.state.highest} title = "ZODIAC SIGN" points = {this.state.points}>  </Title>
